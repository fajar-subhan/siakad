...
<head>
    ...
    <link rel="icon"  href="{{ asset('storage/images/logo/logo.ico') }}" />
    <!--begin::Fonts-->
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <!--begin::Logo-->
                    <a href="#">
                        <img alt="Logo" src="{{ asset('storage/images/logo/logo.svg') }}" class="h-100px  logo" style="margin-top:25% !important" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="../../demo1/dist/index.html" class="d-lg-none">
                                <img alt="Logo" src="{{ asset('storage/images/logo/logo.svg') }}"
                                    class="h-50px" />
                            </a>
                        </div>
                        <!--end::Mobile logo-->
                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                        ...
                                        <div class="menu-item me-lg-1">
                                            <span class="svg-icon svg-icon-2x svg-icon-primary">
                                                <!--begin::Svg Icon | path: assets/media/icons/duotune/abstract/abs008.svg-->
                                                <span class="svg-icon svg-icon-2hx"><svg
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                            ...
                                            <div class="menu-item px-3">
                                                <div class="menu-content d-flex align-items-center px-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        @else
                                                            <span
                                                                class="fw-bold text-muted text-hover-primary fs-7">@php echo \Auth::user()->nim ?? \Auth::user()->nidn  @endphp</span>
                                                        @endif
                                            ...
                                            <div class="menu-item px-5">
                                                <a href="/profile" id="profile" class="menu-link px-5">
                                                    <span class="menu-icon">
                                                        <i class="fa-solid fa-circle-user" style="font-size: 15px"></i>
                                                    </span>
                                                    {{ __('Profile') }}</a>

                                                <a href="javascript:void(0)" id="logout" class="menu-link px-5">
                                                    <span class="menu-icon">
